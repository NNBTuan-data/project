    ...
    def download_class(self, class_name: str, num_images: int = NUM_IMAGES_PER_CLASS) -> int:
        ...
        with ThreadPoolExecutor(max_workers=self.max_workers) as executor:
            ...
            for future in as_completed(futures):
                if future.result():
                    task = futures[future]
                    successful_files.append(task[1])  # Lưu đường dẫn file temp
                    downloaded += 1
        ...
        # Rename các file thành công theo thứ tự 1, 2, 3... cho đến num_images
        final_count = 0
        if successful_files:
            ...
            # Xóa các file temp thừa (nếu tải được > num_images)
